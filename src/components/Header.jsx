  ...
  return (
    ...
    >
      ...
      //  viewport={{once:true}}
       ...
       >Turn text to <span className='text-blue-700'>image</span>, in seconds.</motion.h1>
        ...
        > Unleash your 
            creativity with AI.Turn your imagination into visual art 
            in seconds - just type, and watch the magic happen. </motion.p>
            ...
            >
                 {Array(6).fill('').map((item,index)=>(
                    ...
                    duration-300 cursot-pointer max-sm:w-10' 
