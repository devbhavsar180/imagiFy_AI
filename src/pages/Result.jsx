...
const Result = () => {
  ...
  return (
    ...
    onSubmit={onSubmithandler} className='flex flex-col min-h-[100vh] justify-center items-center'>
      <div>
      ...
      {isImageLoaded &&
        <div className='flex gap-2 flex-wrapjustify-center text-white text-sm p-0.5 mt-10 rounded-full'>
