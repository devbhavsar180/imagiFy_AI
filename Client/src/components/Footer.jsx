...
const Footer = () => {
  return (
    <div className='flex items-center justify-between gap-4 py-3 mt-20'>
      ...
      <p className='flex-1 border-l border-gray-400 pl-4 text-sm text-gray-500 max-sm:hidden'>Copyright @<span className='text-blue-800'>Dev Bhavsar</span> | All right reserved. </p>
